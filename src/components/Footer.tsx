      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/70">
              <li><Link href="/#four-dimensions" className="hover:text-white transition-colors">Features</Link></li>
          ...
          <div className="flex items-start justify-end space-x-4">
            ...
            <a href="https://github.com/clement893/ARISE" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
